 ...
 * 
 * Generated: 2026-02-22 17:41:22
 * Git commit: 748b7b6 (clean)
 */
...
static constexpr uint32_t VERSION_CODE = 200;

/// @brief Build date (YYYY-MM-DD).
static constexpr const char* BUILD_DATE = "2026-02-22";

/// @brief Build time (HH:MM:SS).
static constexpr const char* BUILD_TIME = "17:41:22";

/// @brief Full build timestamp.
static constexpr const char* BUILD_TIMESTAMP = "2026-02-22 17:41:22";

/// @brief Git commit hash (short).
static constexpr const char* GIT_COMMIT = "748b7b6";
...
static constexpr const char* VERSION_FULL = "0.2.0 (748b7b6, 2026-02-22 17:41:22)";
