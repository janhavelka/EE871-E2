...
| 5 | [`05_firmware_e2_product_and_electrical_decision.md`](05_firmware_e2_product_and_electrical_decision.md) | `TunnelMonitor-node` | Resolve and document the product, pins, electrical interface, role, data, timing, and dependency authority before runtime work. |
...
| 8 | [`08_firmware_ee871_profile_data_and_qualification.md`](08_firmware_ee871_profile_data_and_qualification.md) | `TunnelMonitor-node` | Add the authorized product row, measurement policy, schema/sinks/status, maintenance boundary, and qualification evidence. |
...
Do not execute runtime integration from Prompts 6-8 until Prompt 5's product,
electrical, schema, and maintenance preconditions are explicitly resolved.
